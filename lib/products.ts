...
export const PRODUCTOS: Producto[] = [
  ...
  {
    slug: "bolso-luna",
    nombre: "Bolso de Mano · Lunar",
    categoria: "Bolsos",
    gancho: "Clutch de trapillo jaspeado con asa redonda",
    descripcion:
      "Clutch de trapillo de punto grueso con asa redonda, en jaspeado de negro, crudo y dorado. Pequeño y con carácter, para llevar lo justo con mucho estilo.",
    materiales: "Trapillo de algodón, punto grueso",
    precioDesde: 17000,
    elaboracion: "Se teje para vos en 4 a 7 días",
    imagenes: ["/products/bolso-luna.webp"],
    escena: "/products/bolso-luna-lunar-escena.webp",
    alt: "Clutch de trapillo jaspeado con asa redonda",
    opciones: [hilosColor("negro", "crudo", "arena", "oliva")],
  },
  {
    slug: "bolso-luna-amarillo",
    nombre: "Bolso de Mano · Amarillo",
    categoria: "Bolsos",
    gancho: "Clutch de trapillo amarillo con asa redonda",
    descripcion:
      "Clutch de trapillo de punto grueso con asa redonda, en un amarillo alegre con borlas. Pequeño y con carácter, para darle un toque de color a cualquier salida.",
    materiales: "Trapillo de algodón, punto grueso",
    precioDesde: 17000,
    elaboracion: "Se teje para vos en 4 a 7 días",
    imagenes: ["/products/bolso-luna-amarillo.webp"],
    escena: "/products/bolso-luna-amarillo-escena.webp",
    alt: "Clutch de trapillo amarillo con asa redonda y borlas",
    opciones: [
      {
        id: "color",
        label: "Color del hilo",
  ...
  {
    slug: "bolso-luna-rosa",
    nombre: "Bolso de Mano · Rosa",
    categoria: "Bolsos",
    gancho: "Clutch de trapillo rosa con asa redonda",
    descripcion:
      "Clutch de trapillo de punto grueso con asa redonda, en un rosa jaspeado precioso. Pequeño y con carácter, romántico sin ser dulzón.",
    materiales: "Trapillo de algodón, punto grueso",
    precioDesde: 17000,
    elaboracion: "Se teje para vos en 4 a 7 días",
    imagenes: ["/products/bolso-luna-rosa.webp"],
    escena: "/products/bolso-luna-rosa-escena.webp",
    alt: "Clutch de trapillo rosa jaspeado con asa redonda",
    opciones: [
      {
        id: "color",
        label: "Color del hilo",
